...
SELECT app_name, reviews, min_installs, min_installs/reviews AS "Proportion of Installs to Reviews" FROM analytics WHERE min_installs >= 100000 ORDER BY min_installs/reviews DESC;